...
//               overflowY: "auto",
//               pr: 1,
//               // ensure long text wraps and doesn't force column wider
//               "& .related-title": {
//                 overflow: "hidden",
...
//               // pass className or ensure RelatedVideoItem doesn't set minWidth
...
const WatchPage: React.FC = () => {
  ...
  if (loading) {
    // show full-page skeletons matching left/right layout
    return (
      <Box
        p={2}
        display="grid"
